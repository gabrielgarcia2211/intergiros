    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7 py-5">
                <h3><strong style="color:white">Regístrate en INTERRAPPI</strong></h3>
                <br>
                <form id="camposRegistro" class="form-signup" method="POST" action="{{ route('users.store') }}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p style="color:white">Tu contraseña debe ser de 8 caracteres que contengan números, letras y una letra mayúscula.
                            </p>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-2" style="text-align: center">
                            <p style="color:white">¿Ya tienes una cuenta? <a href="{{ route('login') }}">Iniciar Sesión</a></p>
                        </div>
                    </div>
                </form>
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ asset('img/Slide1.png') }}" class="d-block w-100" alt="..." height="600px"
                                width="auto">
                        </div>
                    </div>
                </div>
